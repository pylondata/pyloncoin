...
Build requirements:
    ...
    sudo apt-get install build-essential libtool autotools-dev automake pkg-config libssl-dev libevent-dev bsdmainutils libdb5.3++-dev libdb5.3-dev zlib1g-dev
