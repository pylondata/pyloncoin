...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Pyloncoin Core pyloncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pyloncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Pyloncoin transaction") + "\n" +
              "  pyloncoin-tx [options] -create [commands]   " + _("Create hex-encoded Pyloncoin transaction") + "\n" +
              "\n";
...
static void MutateTxAddInput(CMutableTransaction& tx, const string& strInput)
{
    ...
    static unsigned int maxVout = dynParams.nMaxBlockSize / minTxOutSz;
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Pyloncoin transaction
