...
const QString BITCOIN_IPC_PREFIX("PYLON:");
...
const char* BIP71_MIMETYPE_PAYMENT = "application/PYLON-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/PYLON-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/PYLON-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                ...
                tr("Cannot start PYLON: click-to-pay handler"));
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    ...
                    tr("URI cannot be parsed! This can be caused by an invalid PYLON address or malformed URI parameters."),
