...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s PYLON-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  PYLON-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded PYLON transaction") + "\n" +
              "  PYLON-tx [options] -create [commands]   " + _("Create hex-encoded PYLON transaction") + "\n" +
