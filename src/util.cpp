...
const char * const BITCOIN_CONF_FILENAME = "PYLON.conf";
const char * const BITCOIN_PID_FILENAME = "PYLON.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PYLON";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/PYLON";
#else
    // Unix
    return pathRet / ".PYLON";
#endif
#endif
}
