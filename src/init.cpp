...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pylonnetwork/pylonnetwork-core>";
    const std::string URL_WEBSITE = "<https://pylonnetwork.org>";
